...
void Slave_GPIO_InterruptPinInit(void)
{
	...
	spiIntPin.pGPIO_PinConfig.GPIO_PinNumber = GPIO_PIN_NO_6;
	spiIntPin.pGPIO_PinConfig.GPIO_PinMode = GPIO_MODE_IT_FT;
	spiIntPin.pGPIO_PinConfig.GPIO_PinSpeed = GPIO_SPEED_LOW;
	spiIntPin.pGPIO_PinConfig.GPIO_PinPuPdControl = GPIO_PIN_PU;
